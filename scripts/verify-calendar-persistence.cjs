...
(async()=>{
 ...
 try{
  ...
  const settings={name:'Integration test',platform:'Custom iCal',url:'https://example.com/synthetic-calendar.ics',checkIn:'15:00',checkOut:'10:00'};
 ...
 }finally{await db`DELETE FROM turnli_calendars WHERE owner_id=${owner}`;}
