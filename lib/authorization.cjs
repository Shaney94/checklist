...
// Role names are read only from the provider's authenticated /me response.
const providerRoles = { 'turnli-cleaner': 'cleaner', 'turnli-host': 'host' };
const rolePermissions = {
 cleaner: ['cleaner.view','workspace.read','workspace.setup','cleaning.work','calendar.read','calendar.manage','preferences'],
 host: ['guide.read','guide.write','host.view','workspace.read','workspace.setup','calendar.read','calendar.manage','preferences'],
};
const hostSections = {
...
module.exports={resolveRole,can,home,workspaceRoute,hostSections,dashboardPermission};
