...
const rolePermissions = {
 cleaner: ['property.accept','property.assigned','completion.submit','workspace.read','workspace.setup','cleaning.work','calendar.read','calendar.manage','cleaner.view','jobs.assigned','guide.assigned','preferences'],
 host: ['property.invite','completion.review','jobs.manage','guide.read','guide.write','host.view','workspace.read','workspace.setup','calendar.read','calendar.manage','preferences'],
};
const hostSections = {
