...
Browser tests use synthetic API fixtures; they do not establish production identity-provider configuration. Invitations, teams, completion approval, photos, notifications and payments are outside this implementation.
