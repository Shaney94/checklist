  ...
  return <AcquisitionPage page={publicPages[1]}>
    <section className="public-container acquisition-hero" aria-labelledby="cleaning-title">
      <div className="hero-copy"><p className="eyebrow">Airbnb & holiday let cleaning · UK</p><h1 id="cleaning-title">Find reliable Airbnb cleaners <em>near you.</em></h1>
        ...
        <div className="public-actions"><a className="public-button" href="/quote">Get your cleaning price <span aria-hidden="true">↗</span></a><a className="public-text-link" href="/software/airbnb-cleaning">Already have a Cleaner?</a></div>
      </div>
      <aside className="acquisition-note" aria-labelledby="availability-title"><p className="eyebrow">Growing, property by property</p><h2 id="availability-title">Need a Cleaner?</h2><p>We’re building Cleaner availability across the UK. See your fixed cleaning price before creating an account; Cleaner availability is still developing and we cannot guarantee a match in your area.</p><p>Already work with someone you trust? With a Host workspace, you can invite them by email and organise your cleans together now.</p></aside>
    </section>
    ...
    <section className="public-container public-section acquisition-section" aria-labelledby="local-title"><p className="eyebrow">Plan for the property and its location</p><h2 id="local-title">A useful local handover.</h2><p className="section-lead">Explore practical cleaning guidance and get a property-specific price. These city guides do not promise Cleaner availability.</p><div className="acquisition-grid">
      <article><h3>Glasgow</h3><p>Prepare building access, tenement handovers and laundry arrangements for the next changeover.</p><a className="public-text-link" href="/airbnb-cleaning/glasgow">Explore Airbnb cleaning in Glasgow <span aria-hidden="true">↗</span></a></article>
      <article><h3>Edinburgh</h3><p>Plan around festival stays, linen turnaround and the time between guest departure and arrival.</p><a className="public-text-link" href="/airbnb-cleaning/edinburgh">Explore Airbnb cleaning in Edinburgh <span aria-hidden="true">↗</span></a></article>
      <article><h3>London</h3><p>Coordinate travel, building entry and cleaning briefs when managing one property or several.</p><a className="public-text-link" href="/airbnb-cleaning/london">Explore Airbnb cleaning in London <span aria-hidden="true">↗</span></a></article>
    </div></section>
    <section className="final-cta" aria-labelledby="start-title"><div className="public-container"><p className="eyebrow">A clearer plan for the next stay</p><h2 id="start-title">Bring your cleaning<br />operations together.</h2><p>See your property’s cleaning price without an account. Or bring your existing Cleaner when you’re ready.</p><div className="public-actions"><a className="public-button" href="/quote">Get your cleaning price <span aria-hidden="true">↗</span></a></div></div></section>
  </AcquisitionPage>;
}
