...
export type Job = { id: string; propertyId: string; propertyName: string; date: string; kind: "regular" | "deep"; state: JobState; revision: number; assigned: boolean; automatic?: boolean; plannedAfter?: string | null; needsAttention?: boolean; issueCount?: number };
