...
export default function HostProperties() {
  ...
  return <div>
    <p>Manage property names and cleaning tasks. Keep access instructions in the Property Start Guide under Cleaning setup.</p>
    ...
    {m.property && <>
      ...
      {kind && <WorkspaceTools key={m.property.id + kind} model={m} kind={kind} onClose={() => setKind(null)} setupOnly />}
    </>}
  </div>;
}
